...
import { ElementRef, ViewChild, HostListener, AfterViewInit, ChangeDetectorRef, ChangeDetectionStrategy } from '@angular/core';
...
export class FieldComponent implements OnInit {
  ...
  getUserInfo() {
    ...
    var data = JSON.parse(localStorage.getItem("progress"));
    console.log(data);
    if (data == null) {
      data = {
        "info": {
    ...
    this.geoElements = data.geoElements;
